...
- [Check your projected balance](/docs/features/projected-balance)
- [Use filtering](/docs/features/filtering-and-search) to see recurring items
- [Review the dashboard](/docs/features/dashboard) for monthly summaries
